...
class QuestionModelTest(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """was_published_recently returns False for questions whose pub_date is inthe future"""
        time = timezone.now() + datetime.timedelta(days=30)
        self.question.pub_date = time
        self.assertIs(self.question.was_published_recently(), False)

    def test_was_published_recently_with_present_question(self):
        """was_published_recently returns True for questions whose pub_date is in the pressent (-24h)"""
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both past and future question exits, only past questions are displayed
        """
    ...
    def test_two_future_question(self):
        """
        The questions index page should not display questions
        """
...
class QuestionResultsViewTest(TestCase):
    def test_question_not_existe(self):
        """
        If question id not exist, get 404
        """
